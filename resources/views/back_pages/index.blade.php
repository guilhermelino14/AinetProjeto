...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <!-- Earnings (Monthly) Card Example -->
            <div class="col-xl-3 col-md-6 mb-4">
                <a href="{{ url('/admin/clientes') }}" style="text-decoration: none">
            ...
            <!-- Earnings (Monthly) Card Example -->
            <div class="col-xl-3 col-md-6 mb-4">
                <a href="{{ url('/admin/encomendas') }}" style="text-decoration: none">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <a href="{{ url('/admin/estampas') }}" style="text-decoration: none">
